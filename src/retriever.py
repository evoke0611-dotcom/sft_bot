...
"""
src/retriever.py  —  minimal change from your existing file.
Only fix: switched client.responses.create → client.chat.completions.create
(client.responses is not a valid OpenAI Python SDK method and causes errors).
...
"""
    ...
    try:
        # ── FIX: was client.responses.create — not a valid SDK method ──────
